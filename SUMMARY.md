...
* [読んで学ぶTypeScript](next/reference/README.md)
  ...
  * [ジェネリクス \(generics\)](next/reference/generics/README.md)
    * [🚧built-in-libraries-using-generics](next/reference/generics/built-in-libraries-using-generics.md)
    * [type-variables](next/reference/generics/type-variables.md)
    * [type-parameter-constraint](next/reference/generics/type-parameter-constraint.md)
    * [default-type-parameter](next/reference/generics/default-type-parameter.md)
