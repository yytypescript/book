...
* [値・型・変数](next/values-types-variables/README.md)
  ...
  * [Primitive Types](next/values-types-variables/primitive-types/README.md)
    * [Primitive Types Introduction](next/values-types-variables/primitive-types/primitive-types-introduction.md)
  ...
  * [Array](next/values-types-variables/array/README.md)
    * [Array Literal](next/values-types-variables/array/array-literal.md)
    * [Type Annotation of Array](next/values-types-variables/array/type-annotation-of-array.md)
    * [Array as a Object](next/values-types-variables/array/array-as-a-object.md)
    * [Readonly Array](next/values-types-variables/array/readonly-array.md)
    * [Destructuring Assignment from Array](next/values-types-variables/array/destructuring-assignment-from-array.md)
    * [Array Operations](next/values-types-variables/array/array-operations.md)
    * [How To Loop an Array](next/values-types-variables/array/how-to-loop-an-array.md)
  * [Tuple](next/values-types-variables/tuple/README.md)
    * [Tuple Introduction](next/values-types-variables/tuple/tuple-introduction.md)
    * [What Does Tuple Resolve?](next/values-types-variables/tuple/what-does-tuple-resolve.md)
    * [How To Access Tuple Items](next/values-types-variables/tuple/how-to-access-tuple-items.md)
    * [Real-World Use of Tuples](next/values-types-variables/tuple/real-world-use-of-tuples.md)
