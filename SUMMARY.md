...
* [🚧作って学ぶTypeScript](next/tutorials/README.md)
  ...
  * [🚧Prettierでコード整形を自動化しよう](next/tutorials/prettier.md)
  * [🚧eslintでコーディング規約チェックを自動化しよう](next/tutorials/eslint.md)
  * [🚧huskyでコミット前チェックを自動化しよう](next/tutorials/husky.md)
* [読んで学ぶTypeScript](next/reference/README.md)
  * [値・型・変数](next/reference/values-types-variables/README.md)
    ...
    * [オブジェクト](next/reference/values-types-variables/object/README.md)
      ...
      * [🚧how-to-loop-an-object](next/reference/values-types-variables/object/how-to-loop-an-object.md)
  ...
  * [文](next/reference/statements/README.md)
    ...
    * [switch文](next/reference/statements/switch.md)
    * [🚧switchのfall-through問題](next/reference/statements/switch-fallthrough.md)
    * [🚧switch-and-variable-scope](next/reference/statements/switch-and-variable-scope.md)
    * [例外処理 \(exception\)](next/reference/statements/exception.md)
    * [🚧never型](next/reference/statements/never.md)
  ...
  * [関数](next/reference/functions/README.md)
    ...
    * [戻り値がない関数とvoid型 \(void type\)](next/reference/functions/void-type.md)
  ...
  * [🚧非同期処理](next/reference/asynchronous/README.md)
    * [🚧promise](next/reference/asynchronous/promise.md)
    * [🚧async](next/reference/asynchronous/async.md)
    * [🚧await](next/reference/asynchronous/await.md)
  * [オブジェクト指向](next/reference/object-oriented/README.md)
    * [クラス \(class\)](next/reference/object-oriented/class/README.md)
      ...
      * [メソッド \(method\)](next/reference/object-oriented/class/methods.md)
      * [フィールドの初期化子 \(initializer\)](next/reference/object-oriented/class/field-initializers.md)
      * [アクセス修飾子 \(access modifier\)](next/reference/object-oriented/class/access-modifiers.md)
  ...
  * [🚧組み込みAPI](next/reference/builtin-api/README.md)
    ...
    * [Set&lt;T&gt;](next/reference/builtin-api/set.md)
    * [🚧Date](next/reference/builtin-api/date.md)
    * [🚧Error](next/reference/builtin-api/error.md)
  ...
  * [ジェネリクス \(generics\)](next/reference/generics/README.md)
    * [🚧ジェネリクスが使われている標準ライブラリ](next/reference/generics/built-in-libraries-using-generics.md)
    * [型変数 \(type variables\)](next/reference/generics/type-variables.md)
    * [型引数の制約](next/reference/generics/type-parameter-constraint.md)
    * [デフォルト型引数](next/reference/generics/default-type-parameter.md)
  * [tsconfig](next/reference/tsconfig/README.md)
    * [Strict Type-Checking Options](next/reference/tsconfig/strict-type-checks/README.md)
      * [strict](next/reference/tsconfig/strict-type-checks/strict.md)
      ...
      * [useUnknownInCatchVariables](next/reference/tsconfig/strict-type-checks/useunknownincatchvariables.md)
    * [Additional Checks](next/reference/tsconfig/additional-checks/README.md)
      ...
      * [exactOptionalPropertyTypes](next/reference/tsconfig/additional-checks/exactoptionalpropertytypes.md)
  ...
  * [Advanced Topics](next/reference/advanced-topics/README.md)
    * [NPMパッケージ開発者のためのtsconfig](next/reference/advanced-topics/tsconfig-for-npm-package-developers.md)
    * [デュアルパッケージ開発者のためのtsconfig \(Dual Package\)](next/reference/advanced-topics/tsconfig-for-dual-package-developers.md)
    * [ジェネレーター \(generator\)](next/reference/advanced-topics/generator.md)
    * [セッターとゲッター \(set, get\)](next/reference/advanced-topics/getters-and-setters.md)
* [🚧Tips](next/tips.md)
