...
* [TypeScriptへようこそ](welcome-to-typescript/README.md)
  ...
  * [JavaScript世界地図](welcome-to-typescript/javascript-shi-jie-di-tu.md)
...
* [関数 \(Functions\)](function.md)
* [配列 \(Array\)](array.md)
* [タプル \(Tuple\)](tuple.md)
* [Enum](enum.md)
* [タイプエイリアス \(Type aliases\)](type-alias.md)
* [ユニオン型 \(Union types\)](union-type.md)
* [インターフェース](intfsu.md)
